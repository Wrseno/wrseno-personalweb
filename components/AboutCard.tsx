    ...
    <div className="w-full self-center px-4 my-8">
        <h1 className="text-lg font-bold mb-4 lg:text-xl">What I&#39;m Doing</h1>
            <ul className="grid lg:grid-cols-2 md:grid-cols-2">
                <li  className="lg:flex justify-start items-start gap-5 p-4 lg:p-4 lg:p-8 border-2 border-gray-500 rounded-xl my-2 mx-2">
                <div>
                ...
                <li  className="lg:flex justify-start items-start gap-5 p-4 lg:p-8 border-2 border-gray-500 rounded-xl my-2 mx-2">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="rgb(220 38 38)" className="mx-auto lg:my-4"viewBox="0 0 16 16">
