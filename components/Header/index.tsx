              ...
              <nav id={menu_class} className="hidden absolute py-5 bg-black font-semibold
               shadow-lg rounded-lg max-w-[200px] w-full right-4 top-full text-white lg:block lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none">
                <ul className="block lg:flex">
                  <li className="group"><Link href="/about"><a className={`${asPath === "/about" ? "font-bold border-b-4 rounded-sm border-primary" : "text-white"} text-base text-dark py-2 mx-8 lg:mx-4 group-hover:text-secondary group-hover:ease-in-out group-hover:duration-300 flex lg:text-lg lg:font-semibold`}>About</a></Link></li>
                  <li className="group"><Link href="/achievement"><a className={`${asPath === "/achievement" ? "font-bold border-b-4 rounded-sm border-primary" : "text-white"} text-base text-dark py-2 mx-8 lg:mx-4 group-hover:text-secondary group-hover:ease-in-out group-hover:duration-300 flex lg:text-lg lg:font-semibold`}>Achievements</a></Link></li>
