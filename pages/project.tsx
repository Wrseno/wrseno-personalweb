          ...
          <section className="container lg:px-36">
            <div className="flex flex-wrap relative">
              ...
              <div className="w-16 h-1.5 rounded-full bg-primary absolute lg:left-96 lg:top-12 left-24 top-10"></div>
                ...
                <div className="flex flex-col lg:my-24 my-16">
                  {projects.map((item, index) => {
                    if (index % 2 == 0) {
                      return <ProjectsCard key={index} project={item} layout={false} />;
                    } else {
                      return <ProjectsCard key={index} project={item} layout={true} />;
                    }
                  })}
                </div>
              </div>
